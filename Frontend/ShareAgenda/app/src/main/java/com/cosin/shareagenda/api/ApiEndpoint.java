...
public final class ApiEndpoint {
    ...
    public static final String EXPLORE_EVENT = "exploreEvent";
    public static final String GET_ACCOUNT = "getAccount";
    public static final String GET_EVENT_MESSAGE_QUEUE = "getEventMessageQueue";
    public static final String GET_EVENT_MONTHLY = "getEventMonthly";
    ...
    public static final String GET_NEW_FRIEND_MESSAGE_QUEUE = "getNewFriendMessageQueue";
    public static final String GET_OCCUPIED_TIME = "getOccupiedTime";
