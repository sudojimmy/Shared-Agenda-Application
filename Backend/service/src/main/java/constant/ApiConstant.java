...
public class ApiConstant {
    // Account
    public static final String ACCOUNT_ACCOUNT_ID = "accountId";
    public static final String ACCOUNT_NICKNAME = "nickname";
    public static final String ACCOUNT_DESCRIPTION = "description";

    // Calendar
    public static final String CALENDAR_CALENDAR_ID = "calendarId";
    ...
    // Friend
    public static final String FRIEND_FRIEND_ID = "friendId";
